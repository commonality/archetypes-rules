  ...
  describe('represents a fact in time, where', () => {
    ...
    describe('addProposition(n: string, v: boolean)', () => {
      it('puts a new proposition to its "elements" Map', () => {
        ...
        const ruleElement = addPropositionFact.findElementByName('proposition')
    ...
    describe('addVariable(n: string, v: any)', () => {
      it('puts a Variable on its "elements" Map', () => {
        ...
        const ruleElement = addVariableFact.findElementByName('foo')
    ...
    describe('findElementByName(n: string)', () => {
      it('returns an element', () => {
        ...
        expect(fact.findElementByName('p')).toBeDefined()
        expect(fact.findElementByName('q')).toBeDefined()
        expect(fact.findElementByName('question')).toBeDefined()
        expect(fact.findElementByName('answer')).toBeUndefined()
      })
    })

    describe('findRuleOverrideByName(n: string)', () => {
      let context = null
      beforeEach(() => {
        context = new RuleContext('find-rule-override-by-name')
        context.addRuleOverride(
          new RuleOverride('override-test', true)
        )
      })
      ...
      describe('when a RuleOverride exists', () => {
        it('returns the RuleOverride', () => {
          const override = context.findRuleOverrideByName('override-test')
      ...
      describe('when a RuleOverride does NOT exist', () => {
        it('returns undefined', () => {
          const override = context.findRuleOverrideByName('foobar')
