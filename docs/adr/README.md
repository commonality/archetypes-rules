...
- [[1. Use ADRs][adr-0001]](#1-use-adrsadr-0001)
- [[2. Modular Design][adr-0002]](#2-modular-designadr-0002)
- [[Architecture Decision Guide][ad-wiki]](#architecture-decision-guidead-wiki)
...
[ad-wiki]:
  https://gitlab.com/archetypes-rules/signatures/wikis/Governance/Architecture-Decisions#architecture-decisions-ads
