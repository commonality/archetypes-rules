...
This guide is intended for those who work as part of the @archetypes/rules
...
Describes how to do a release for @archetypes/rules.

## 4. [Governance](governance.md)

Describes the governance policy for @archetypes/rules, including the rights and
